...
const DICT: Record<string, { en: string; zh: string }> = {
  ...
  'ai.pickSub': { en: 'Tick what you want to cook with.', zh: '勾要拿來做菜的食材。' },
  'ai.picked': { en: '{n} picked', zh: '已選 {n} 樣' },
  'ai.go': { en: 'Think of 3 dishes ›', zh: '想 3 道菜 ›' },
  'ai.title': { en: 'Cook from your list', zh: '用清單做菜' },
  'ai.weekTitle': { en: "Dinner from this week's specials", zh: '用本週特價做晚餐' },
  'ai.homeEntry': { en: "AI: 3 dinners from this week's specials ›", zh: 'AI 用本週特價想 3 道晚餐 ›' },
  'ai.homeEntrySignIn': { en: 'AI dinners from specials · sign in', zh: 'AI 用本週特價想晚餐 · 需登入' },
  'ai.anchors': { en: 'You have: {s}', zh: '你有：{s}' },
  'ai.notFood': { en: 'Not ingredients, left out: {s}', zh: '不算食材，不會用到：{s}' },
  'ai.poolSub': { en: 'Ingredients come only from what you have and {n} specials at your stores this week, so every item has a price.', zh: '食材只從你有的、和你的店這週 {n} 樣特價裡挑，所以每樣都有價格。' },
  ...
  'ai.thinking': { en: 'Thinking of 3 dishes… about 10 seconds', zh: '正在想 3 道菜…大約 10 秒' },
  ...
  'ai.rethink': { en: 'Another 3', zh: '換 3 道' },
  'ai.none': { en: "Couldn't make a real dish from these plus this week's specials. Pick a few more things — a protein, a veg or a carb helps.", zh: '這幾樣加上本週特價湊不出像樣的菜。回去多勾幾樣，有肉、菜或主食比較好發揮。' },
  'ai.few': { en: 'Not enough to work with. Pick your stores first (that gives us the specials), or tick more items.', zh: '東西太少了。先選店（才有本週特價可以配），或多勾幾樣。' },
  'ai.pickMore': { en: 'Pick more', zh: '回去多勾幾樣' },
