...
const DICT: Record<string, { en: string; zh: string }> = {
  ...
  'ai.picked': { en: '{n} picked (2+ to go)', zh: '已選 {n} 樣（至少 2 樣）' },
  ...
  'ai.none': { en: "These don't add up to a real dish. Pick a few more things — a protein, a veg or a carb helps.", zh: '這幾樣湊不出一道像樣的菜。多勾幾樣試試，有肉、菜或主食比較好發揮。' },
