...
const DICT: Record<string, { en: string; zh: string }> = {
  ...
  'p.followNote': {
    en: "Follow needs a sign-in — we'll tell you when it's on special again",
    zh: '關注要登入 —— 再有特價我們就通知你',
  },
  ...
  'half.note': {
    en: "PAK'nSAVE isn't here — it doesn't publish was-prices, so % off can't be computed.",
    zh: "PAK'nSAVE 不在這裡 —— 它沒有原價，算不出折數。",
  },
