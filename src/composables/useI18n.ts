...
const DICT: Record<string, { en: string; zh: string }> = {
  ...
  'list.others': { en: 'Other items · no special', zh: '其他要買的 · 沒特價' },
  ...
  'list.nameNone': { en: 'not found here · probably not sold', zh: '找不到 · 可能沒賣' },
  'list.nameReview': { en: 'price unknown · needs a manual check', zh: '價格未知 · 待人工確認' },
