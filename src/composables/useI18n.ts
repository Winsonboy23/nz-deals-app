...
const DICT: Record<string, { en: string; zh: string }> = {
  ...
  'watching.noSpecial': { en: 'No data at your stores this week', zh: '你的店本週沒有資料' },
  ...
  'home.recipes': { en: 'Cook this week', zh: '這週煮什麼' },
  'home.allRecipes': { en: 'All {n} ›', zh: '全部 {n} 道 ›' },
  ...
  'home.noCompare': {
    en: 'No item was found on special at 2+ of your stores this week.',
    zh: '本週沒有在兩家以上都查到特價的商品。',
  },
  ...
  'cmp.noSpecial': { en: 'no data this week', zh: '本週沒有資料' },
  'cmp.noSpecialAt': { en: '{s} — no data this week', zh: '{s} — 本週沒有資料' },
  'cmp.noSpecialCount': { en: '{n} other stores — no data this week', zh: '另外 {n} 家本週沒有資料' },
  'cmp.only': { en: 'ONLY STORE WITH DATA', zh: '只有這家有資料' },
  ...
  'price.club': { en: 'CARD', zh: '卡' },
  'price.multi': { en: 'BUY {q}', zh: '{q} 件' },
  'price.multiQty': { en: '{q} for ', zh: '{q} 件 ' },
  'price.regular': { en: 'regular {v}', zh: '一般價 {v}' },
  'price.multiDetail': { en: '{u} each · {s} single', zh: '每件 {u} · 單買 {s}' },
  ...
  'search.empty': { en: 'No data for "{q}"', zh: '「{q}」沒有資料' },
  'search.emptyHint': {
    en: "We only hold this week's specials, and the store may run more in-store.",
    zh: '我們只收錄本週線上特價，店內可能還有。',
  },
  'search.more': { en: 'Show {n} more', zh: '再顯示 {n} 筆' },
  'search.stack': { en: '+{n} more at this price', zh: '同價還有 {n} 款' },
  'search.stackHide': { en: 'Hide', zh: '收起' },
  ...
  'p.notFound': { en: 'No data for this item at your stores this week.', zh: '你的店本週沒有這項資料。' },
  ...
  'list.addPlaceholder': { en: 'No special? Still add it: milk, toilet paper…', zh: '沒特價的也能記：牛奶、衛生紙…' },
  'list.others': { en: 'Other items · no data', zh: '其他要買的 · 沒有資料' },
  'list.selfPrice': { en: 'your price', zh: '自己填的' },
  ...
  'list.approx': { en: 'about {v}', zh: '約 {v}' },
  'list.missingNames': { en: 'Missing: {names}', zh: '缺 {names}' },
  ...
  'list.grpNone': { en: '{s} has no match ({n})', zh: '{s} 沒有同一款（{n}）' },
  ...
  'list.checking': { en: 'checking…', zh: '查詢中…' },
  'list.stReview': { en: 'similar item found, awaiting check', zh: '找到類似的，待確認' },
  'list.stUnknown': { en: "couldn't get a price", zh: '查不到價格' },
  'list.stNeedCount': { en: "can't convert · enter how many", zh: '無法換算 · 填數量' },
  'list.noEstimate': { en: 'no estimate', zh: '無法估算' },
  'list.withSubs': { en: ' ({n} substitutes)', zh: '（含 {n} 樣替代品）' },
  'list.withSub1': { en: ' (1 substitute)', zh: '（含 1 樣替代品）' },
  'list.tagSub': { en: 'SUBSTITUTE', zh: '替代品' },
  'list.tagShelfSame': { en: 'SHELF PRICE', zh: '貨架價' },
  'list.seenAt': { en: 'shelf price as of {d}', zh: '{d} 的貨架價' },
  'list.approxShort': { en: '~', zh: '約' },
  'list.countPcs': { en: 'pcs', zh: '個' },
  'list.aiLeftover': { en: "Better unit price! Turn the leftovers into tomorrow's meal with AI", zh: '單價較划算！剩下的食材可以用 AI 做成明天的菜' },
  'list.queueAhead': { en: ' · {n} ahead in queue', zh: ' · 前面還有 {n} 張' },
  'list.unmatched': { en: 'Not matched to a special', zh: '沒有配對到特價' },
  // 自由輸入配對（一站式購物改版規格 §4.3，useFreeText）
  'list.matchBtn': { en: 'Match', zh: '配對' },
  'list.pickTitle': { en: 'Which one did you mean?', zh: '你是要哪一個？' },
  'list.pickTyped': { en: 'You typed “{q}”', zh: '你打的是「{q}」' },
  'list.pickRemote': { en: 'Found on the supermarket websites', zh: '從超市網站搜到的' },
  'list.pickStores': { en: 'At {n} of your stores · from {v}', zh: '{n} 家有 · 最低 {v}' },
  'list.pickStoresNoPrice': { en: 'At {n} of your stores', zh: '{n} 家有' },
  'list.pickNone': { en: 'None of these, keep as typed', zh: '都不是，照原樣記下' },
  'list.zhOnly': { en: 'Chinese only searches our own data', zh: '中文只能查我們的資料' },
  'list.searching': { en: 'Searching…', zh: '搜尋中…' },
  'list.notFoundFree': { en: 'Not found · free text', zh: '查不到 · 自由輸入' },
  'list.notFoundZh': { en: 'Not found · Chinese only searches our own data', zh: '查不到 · 中文只能查我們的資料' },
  'list.matched': { en: 'Matched: {name}', zh: '已配對：{name}' },
  'list.typed': { en: 'you typed “{q}”', zh: '你打的「{q}」' },
  'list.matchFailed': { en: "Couldn't match it, kept as typed", zh: '配對不成，先照原樣記下' },
  ...
  'ai.title': { en: 'Cook from your list', zh: '用清單做菜' },
  'ai.pickSub': { en: 'Which of these should go in? Food is ticked for you; drinks and snacks stay out.', zh: '要用哪些？食物幫你勾好了，飲料零食不算。' },
  'ai.notFoodTag': { en: 'not food', zh: '不算食材' },
  'ai.maxPicked': { en: 'Up to {n} items.', zh: '最多 {n} 樣。' },
  'ai.extraPlaceholder': { en: 'Anything else you have? e.g. eggs', zh: '還有什麼食材？例如：雞蛋' },
  'ai.pickOne': { en: 'Tick or add at least one thing.', zh: '至少勾或加一樣。' },
  'ai.poolSub': { en: 'Anything to buy comes only from {n} specials at your stores this week, so it has a price.', zh: '要買的只從你的店這週 {n} 樣特價裡挑，所以都有價格。' },
  'ai.q1': { en: 'How many people?', zh: '幾人份？' },
  'ai.q2': { en: 'Ready within?', zh: '多久內做好？' },
  'ai.q3': { en: 'Spicy?', zh: '辣不辣？' },
  'ai.q4': { en: "Likes, or things you don't eat?", zh: '喜好或不吃什麼？' },
  'ai.qDiff': { en: 'How hard?', zh: '難易度？' },
  ...
  'ai.similar': { en: 'similar item', zh: '同類替代' },
  'ai.spice.mild': { en: 'Not spicy', zh: '不辣' },
  'ai.spice.medium': { en: 'A bit spicy', zh: '微辣' },
  'ai.spice.hot': { en: 'Spicy', zh: '辣' },
  'ai.notesPlaceholder': { en: "Likes or don't-eats? e.g. light, no pork", zh: '喜好或不吃什麼？例如：清淡、不吃豬肉' },
  'ai.generate': { en: 'AI recipe', zh: 'AI 食譜' },
  'ai.regenerate': { en: 'Another 2', zh: '再想 2 道' },
  'ai.thinking': { en: 'Thinking… about 10 s', zh: '正在想…大約 10 秒' },
  'ai.have': { en: 'you have {n}', zh: '你有 {n} 樣' },
  'ai.buy': { en: 'buy {n}', zh: '要買 {n} 樣' },
  'ai.approx': { en: '≈ {v}', zh: '約 {v}' },
  'ai.noBuy': { en: 'Nothing to buy', zh: '不用買東西' },
  'ai.expand': { en: 'Ingredients & method ▾', zh: '看食材和做法 ▾' },
  'ai.collapse': { en: 'Collapse ▴', zh: '收起 ▴' },
  'ai.none': { en: "Couldn't make a real dish from these. Swap a few things or add one more ingredient.", zh: '這幾樣湊不出像樣的菜。換幾樣，或多加一樣食材。' },
  'ai.few': { en: 'Not enough to work with. Pick your stores first (that gives us the specials), or add more items.', zh: '東西太少了。先選店（才有本週特價可以配），或多加幾樣。' },
  'ai.badge': { en: 'AI RECIPE', zh: 'AI 食譜' },
  'ai.inList': { en: 'You have this', zh: '你有了' },
  'ai.buyNoSpecial': { en: 'Need to buy · no data this week', zh: '要買 · 本週沒有資料' },
  ...
  'recipes.oneStore': { en: 'Get {n}/{m} at {s}', zh: '去 {s} 買齊 {n}/{m} 樣' },
  'recipes.oneStoreSub': { en: 'All from {s}', zh: '都在 {s} 買' },
  'recipes.cheapestSplit': { en: 'Cheapest · {k} stores', zh: '最便宜 · 分 {k} 家' },
  'recipes.noSpecial': { en: 'No data this week', zh: '本週沒有資料' },
  'recipes.notOnSpecial': { en: 'NO DATA', zh: '沒有資料' },
